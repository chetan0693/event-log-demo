...
def read_options():
    parser = OptionParser()
    parser.add_option("-t", "--time", dest="duration", help="Generate logs for X Hours. Default=48H", default="48", type="int")
    parser.add_option("-l", "--legit-connection", dest="legal", help="How many legal users are connecting. Default=100", default="100", type="int")
