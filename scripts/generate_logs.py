...
def read_options():
    parser = OptionParser()
    parser.add_option("-d", "--duration", dest="duration", help="Generate logs for X Hours. Default=48H", default="48")
    parser.add_option("-l", "--legal-connection", dest="legal", help="How many legal users are connecting. Default=100", default="100")
    parser.add_option("-s", "--start-ddos", dest="start", help="Start DDoS after X hours. Default=24H", default="24")
    parser.add_option("-i", "--ddos-connection", dest="ddos", help="How many DDoS connection. Default=10000", default="10000")
...
def weight_success(success_rate):
